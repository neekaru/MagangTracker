...
class LaporanController extends Controller
{
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(
            new class($mahasiswa, $magang, $absensis, $logbooks, $totalKehadiran, $totalIzin, $totalSakit, $persentaseKehadiran, $totalLogbook, $logbookApproved, $logbookPending, $logbookRejected) implements 
                ...
                protected $persentaseKehadiran;
                protected $totalLogbook;
                protected $logbookApproved;
                protected $logbookPending;
                protected $logbookRejected;

                public function __construct($mahasiswa, $magang, $absensis, $logbooks, $totalKehadiran, $totalIzin, $totalSakit, $persentaseKehadiran, $totalLogbook, $logbookApproved, $logbookPending, $logbookRejected)
                {
                    ...
                    $this->totalLogbook = $totalLogbook;
                    $this->logbookApproved = $logbookApproved;
                    $this->logbookPending = $logbookPending;
                    $this->logbookRejected = $logbookRejected;
                }
