        ...
        <div class="col-md-4">
            <div class="card shadow-sm mb-4">
                <div class="card-body text-center">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($magang->mahasiswa->nama_lengkap ?? 'N/A') }}&background=random"
                    ...
                    <p class="text-muted small mb-2">{{ $magang->mahasiswa->prodi ?? '-' }}</p>
                    <span
                        class="badge bg-{{ $magang->status_magang == 'Aktif' ? 'success' : 'secondary' }}">{{ $magang->status_magang }}</span>
                </div>
            </div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        @if($recentAbsen)
                            <li class="list-group-item">
                                ...
                                Absensi: {{ $recentAbsen->status_absensi }} @if($recentAbsen->jam_masuk) -
                                {{ $recentAbsen->jam_masuk->format('H:i') }}@endif
                            </li>
                        @endif
