...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Unit Bisnis</h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('unit-bisnis.update', $unit->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_unit_bisnis') is-invalid @enderror"
                                id="nama_unit_bisnis" name="nama_unit_bisnis"
                                value="{{ old('nama_unit_bisnis', $unit->nama_unit_bisnis) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('id_periode') is-invalid @enderror" id="id_periode" name="id_periode">
                                ...
                                @foreach($periodes as $periode)
                                    <option value="{{ $periode->id }}" {{ old('id_periode', $unit->id_periode) == $periode->id ? 'selected' : '' }}>
