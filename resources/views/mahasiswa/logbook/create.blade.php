            ...
            <div class="card-body">
                <form action="{{ route('mahasiswa.logbook.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_logbook" name="tanggal_logbook" value="{{ date('Y-m-d') }}" required>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="deskripsi_kegiatan" name="deskripsi_kegiatan" rows="4" required placeholder="Jelaskan kegiatan yang anda lakukan hari ini..."></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="hasil_kegiatan" class="form-label">Output / Hasil</label>
                        <input type="text" class="form-control" id="hasil_kegiatan" name="hasil_kegiatan" placeholder="Contoh: Dokumen laporan, Fitur login selesai, dll.">
                    </div>
                    <div class="mb-3">
