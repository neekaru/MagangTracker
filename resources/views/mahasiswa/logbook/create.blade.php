...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ url('/mahasiswa/logbook') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="kegiatan" name="kegiatan" rows="4" required placeholder="Jelaskan kegiatan yang anda lakukan hari ini..."></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="output" class="form-label">Output / Hasil</label>
                        <input type="text" class="form-control" id="output" name="output" placeholder="Contoh: Dokumen laporan, Fitur login selesai, dll.">
                    </div>
                    <div class="mb-3">
