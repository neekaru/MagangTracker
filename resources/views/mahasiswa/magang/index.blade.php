        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card shadow-sm mb-4">
                    <div
                        class="card-header @if ($status_magang == 'Aktif') bg-success @elseif($status_magang == 'Pending') bg-warning @else bg-secondary @endif text-white">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="progress mb-3">
                            <div class="progress-bar bg-success" role="progressbar" style="width: {{ $kehadiran_persen }}%"
                                aria-valuenow="{{ $kehadiran_persen }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
